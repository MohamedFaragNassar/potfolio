...
const projects = [
  {
    ...
    snippit:
      "A web Application designed to assist a project manager in developing a schedule, assigning resources to tasks, tracking progress, managing the budget, and analyzing workloads.( Microsoft Project clone)",
    live: "https://product-manager-tx5a.onrender.com/",
  ...
  },
  {
    ...
    snippit:
      "E-Commerce platform for electronic devices, where you can buy your favorite devices or save them in your whishlist to buy later. All the data for products,orders and users can be managed through the admin dashboard ",
  ...
  },
  {
    title: "Social App",
    snippit:
      "Social Media Platform where you can share your thoughts, follow other people stories and control the privacy of your account    .( Twitter Clone )",
  ...
  },
  {
    ...
    snippit:
      "A Platform For Renting Services, you can join as a seller to offer your services or as a client to find the best seller for the service your looking for. The services allowed on the app can be managed through the admin dashboard",
...
const Projects = () => {
  return (
    <div className='w-full flex items-center justify-center bg-gr pb-20 relative'>
      ...
      <svg
        className='absolute -top-40 z-10 hidden lg:block'
