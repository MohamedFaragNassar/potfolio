...
const Contact = () => {
    ...
    return <>
        ...
        <div className='w-full flex items-center justify-center relative'>
            ...
            <form id='contact'  action="https://formspree.io/f/xpzbwzyr" method="POST"
                className=' h-screen w-full md:w-5/6 lg:w-11/12 flex  items-center justify-center relative'>
           
                <div className='w-1/2 h-full lg:flex items-center justify-center hidden'>
                    <img src='mail.svg ' className='w-full h-3/4' alt='sending-email-art'/>
                </div>
