...
const Navbar = () => {
  ...
  return (
    <div
      id='nav'
      className='w-full h-14 border border-b-2 fixed top-0 
    ...
    >
      <div className='w-full md:w-5/6 lg:w-11/12 h-full flex items-center justify-between'>
        <button
          className='ml-4 md:ml-0 px-4 py-1 bg-mc text-white font-bold
                text-2xl rounded-sm font-sans cursor-pointer'
        ...
        <div className='hidden md:flex items-center md:w-2/5 lg:w-1/4 justify-between'>
          <span
            onClick={() => scrollTo("landing")}
            className='cursor-pointer hover:text-tc font-medium'
          >
            Home
          </span>
          <span
        ...
        <div className='pr-4 relative md:hidden lg:block'>
          <div className='hidden lg:flex items-center justify-center'>
            <a
              ...
              href='https://drive.google.com/file/d/1hkevxawGYkq9aFpyBuH2Us5JSL7l6EA6/view'
            >
              <img
