...
const Landing = () => {
  return (
    <div
      id='landing'
      className='w-full sec flex flex-col md:flex-row  items-center justify-start md:justify-center
                        pt-16 md:pt-0 '
    >
      <div
        className='w-full  md:mt-28 lg:mt-10 md:w-5/6  lg:w-11/12  
            flex items-center md:h-full relative'
      >
        <div
          className='flex items-center justify-end w-full absolute 
        ...
        >
          ...
          <a
            target='_blank'
            rel='noopener noreferrer'
            href='https://www.linkedin.com/in/mohamed-farag-81530210a/'
          >
            <img
        ...
        <div
          className=' w-full mt-10 md:mt-0 md:w-1/2 h-full flex flex-col items-start justify-center  
                   md:justify-start md:pt-20 lg:justify-center lg:pt-0 p-4 '
        >
          <span className='text-xl md:text-2xl font-bold text-tc'>Hi,</span>
          <span className='text-xl md:text-2xl font-bold text-tc'>
            I am Mohamed Farag
          </span>
          <span className='text-lg md:text-xl font-bold text-tc-s'>
            Frontend Engineer
          </span>
          <p className='mt-4 text-gray-800  md:text-gray-600 text-lg w-5/6 md:w-3/4 '>
            As a Frontend Engineer, I specialize in developing engaging user
            interfaces with React and tools that optimize business performance,
            utilizing a pragmatic approach with a focus on developing clean,
            accessible code that maximizes user experience and satisfaction.
          </p>
        </div>
        <div
      ...
      <svg
        className='absolute  w-full hidden lg:block wave-top'
      ...
      <img
        src='simg1.svg'
        className='absolute sec-img -z-10 opacity-30 md:hidden'
        alt='art'
      />
    </div>
  );
